...
uniform mat4 gLightSpace;
uniform mat4 gLightProjection;

out vec2 tex_coord_0;
out vec3 normal_0;
out vec4 world_position_0;
out vec4 lightspace_position_0;

void main() {
    world_position_0 = gWorld * vec4(position, 1.0);
    gl_Position = gPerspective * gCamera * world_position_0;
    lightspace_position_0 = gLightProjection * gLightSpace * world_position_0;
